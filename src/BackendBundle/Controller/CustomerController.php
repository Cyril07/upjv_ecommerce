...
use BackendBundle\Entity\Customer;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('BackendBundle:Customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BackendBundle\Form\CustomerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('BackendBundle\Form\CustomerType', $customer);
